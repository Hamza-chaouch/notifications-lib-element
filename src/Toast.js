...
export default class Toast {
  ...
  constructor(options) {
    ...
    let typeNotif = options.type ? options.type : DEFAULT_OPTIONS.type;

    this.#toastElem.classList.add(typeNotif + "-notif");
...
class ToastCustomELement extends HTMLElement {
  toast;
  constructor() {
    super();
  }
  ...
  connectedCallback() {
    ...
    this.toast = new Toast(JSON.parse(options));
  }
}

customElements.define("toast-notifications", ToastCustomELement);
